(function() {
  ...
  gulp.task('dev', ['clean:dev', 'debug', 'server:dev', 'watch:dev']);
  gulp.task('dev:concat', ['clean:dev:concat', 'debug', 'server:dev:concat', 'watch:dev:concat']);

  //# DEPLOY TASKS #################################################################
  gulp.task('deploy:dist', ['clean', 'index.min']);
  gulp.task('deploy:dev', ['clean:dev', 'debug', 'inject:dev']);
  gulp.task('deploy:dev:concat', ['clean:dev:concat', 'debug', 'inject:dev:concat']);
